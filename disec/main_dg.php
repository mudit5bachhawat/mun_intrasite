<?php 
	session_start();
		...
		if (is_logon()==1) header('Location: main_ip.php');
...
<html><head>
	...
	<script type="text/javascript" charset="utf-8">
    	...
    	$(document).ready(function() {
			...
			load_all();
			setInterval(function(){ if (ajax_working==false) load_all();},200);
        });
  ...
  <!--Modal-->
              ...
              <div class="modal-dialog" style="margin-top: 265px;">
                <div class="modal-content">
                  ...
                  <div class="col-md-10"><h3 style="margin:10px">Sending message for approval.</h3></div>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div>
